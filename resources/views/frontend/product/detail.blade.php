    ...
    <div class="container mt-4">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb bg-light p-2 breadcrumb-my">
                ...
                <li class="breadcrumb-item"><a
                        href="{{ route('frontend.product.index') }}">{{ language('frontend.product.name') }}</a></li>
                <li class="breadcrumb-item active" aria-current="page">{{ $product->productsTranlations[0]->name }}</li>
            </ol>
        </nav>
    </div>
@endsection
