    ...
    <div class="container mt-4">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb bg-light p-2 breadcrumb-my">
                ...
                <li class="breadcrumb-item active" aria-current="page">{{ language('frontend.gallery.name') }}</li>
            </ol>
        </nav>
    </div>
@endsection
                ...
                <div class="gallery-box">
                    <div class="row">
                        ...
                        @foreach($galleries as $gallery)
                            ...
                            <div class="col-md-4">
                                <a href="{{ route('frontend.gallery.detail',$gallery->slug) }}">
