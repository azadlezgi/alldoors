                ...
                <div class="container">
                    <div class="about-index__wrapper">
                        ...
                        <div class="about-index__content">
                            <div class="h1 about-index__title">{{ language('frontend.home.about_title') }}</div>
                            <div class="about-index__desc">
                                {!! language('frontend.home.about_text') !!}
                            </div>
                            <a href="{{ language('frontend.home.about_url') }}" class="btn btn_block about-index__btn">{{ language('frontend.home.about_button') }}</a>
                        </div>
