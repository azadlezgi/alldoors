...
<head>
    ...
    <title>{{ language('general.title') }}</title>

    <!-- Fonts -->
    <link href="https://fonts.googleapis.com/css2?family=Nunito:wght@400;600;700&display=swap" rel="stylesheet">
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.0.0-beta1/dist/css/bootstrap.min.css" rel="stylesheet"
          integrity="sha384-giJF6kkoqNQ00vy+HMDP7azOuL0xtbfIcaT9wjKHr8RbDVddVHyTfAAsrekwKmP1" crossorigin="anonymous">
    <link rel="stylesheet" href="{{ asset('assets/plugins/socicon/css/socicon.min.css') }}">
    <!-- Styles -->
    <style>
        body {
            background: #F7FAFC;
        ...
        .language .languages-list ul li:hover {
            background: #e8e8e8;
            transition: background-color 0.2s;
        }

        .language .languages-list ul li img {
            margin-right: 3px;
            width: 22px;
        }
        ...
        <div class="col-md-12">
            <nav class="navbar navbar-expand-lg navbar-light bg-warning">
                <div class="container-fluid">
                    <a class="navbar-brand" href="{{ route('frontend.home.index') }}">Navbar</a>
                                    ...
                                    <div class="language-default">
                                        ...
                                        @foreach($allLanguages as $language)
                                            @if($currentLang == $language->code)
                                                <img src="{{ countryFlag($language->code) }}" alt="">
                                                <div> {{ $language->short_name }}</div>
...
<div class="relative flex items-top justify-center min-h-screen bg-gray-100 dark:bg-gray-900 sm:items-center sm:pt-0">
    ...
    <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
        ...
        <div style="color:#24d401;font-size: 25px;font-weight: 900">

            {!! language('blog.test') !!}
            <br>
            {!! language('blog.baxruz') !!}
            <hr>
        </div>
        <div class="mt-8 bg-white dark:bg-gray-800 overflow-hidden shadow sm:rounded-lg">
            ...
            @foreach(json_decode(setting('social')) as $key => $value)
                ...
                <i class="socicon-{{ $value->name }} text-dark-50"></i>
            @endforeach
            <br>
            <br>
            <br>
            ...
            {{ __('messages.welcome') }}
            <hr>
            <a target="_blank" href="{{ route('home.item',1) }}">Link get</a>
            <hr>
