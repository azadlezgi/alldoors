            ...
            <div class="card card-custom gutter-b">
                <div class="card-header">
                    <div class="card-title">
                        <h3 class="card-label">Qalereyalar Axtar</h3>
                    </div>
                    ...
                    <table class="table table-hover table-striped" data-sorting="true">
                        ...
                        @foreach($galleries as $gallery)
                            <tr class="table-id-{{ $gallery->id }}" data-index="{{ $gallery->id }}" data-position="{{ $gallery->sort }}">
                                ...
                                <!--  NAME  -->
                                <td><a href="{{ route('admin.gallery.edit',$gallery->id) }}">{{ $gallery->name }}</a></td>
                                ...
                                <!--  Tarix  -->
                                <td>{{ \Illuminate\Support\Carbon::parse($gallery->updated_at)->format('Y-m-d H:i') }}</td>
