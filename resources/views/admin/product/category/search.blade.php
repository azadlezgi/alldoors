                        ...
                        @foreach($productCategories as $key => $productCategory)
                            ...
                            <tr class="table-id-{{ $productCategory->id }}" data-index="{{ $productCategory->id }}" data-position="{{ $productCategory->sort }}">
                                ...
                                <td>
                                    ...
                                    {{--                                    <a href="{{ route('admin.product.category.edit',$productCategory->id) }}">{{ $productCategory->productsCategoriesTranlations[0]->name }}</a>--}}
                                </td>
                                ...
                                <!--  Tarix  -->
                                <td>{{ updateDate($productCategory->updated_at,$productCategory->productsCategoriesTranlations) }}</td>
