                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input
                                                                                ...
                                                                                value="{{ old('name.'. $language->id,getTranslateData($productModel->productsModelsTranlations,$language->id,'name')) }}"
                                                                                class=" form-control">
                                                                        ...
                                                                        <div class="form-group">
                                                                            ...
                                                                            <textarea
                                                                                ...
                                                                                class="tinymceEditor form-control">{{ old('text.'. $language->id,getTranslateData($productModel->productsModelsTranlations,$language->id,'text')) }}</textarea>
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input
                                                                                ...
                                                                                value="{{ old('title.'. $language->id,getTranslateData($productModel->productsModelsTranlations,$language->id,'title')) }}"
                                                                                class=" form-control">
                                                                        ...
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input
                                                                                ...
                                                                                value="{{ old('keyword.'. $language->id,getTranslateData($productModel->productsModelsTranlations,$language->id,'keyword')) }}"
                                                                                class=" form-control">
                                                                        ...
                                                                        <div class="form-group">
                                                                            ...
                                                                            <textarea
                                                                                ...
                                                                                class=" form-control">{{ old('description.'. $language->id,getTranslateData($productModel->productsModelsTranlations,$language->id,'description')) }}</textarea>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <div class="save-tools-item">
                                        ...
                                        <div>{{ updateDate($productModel->updated_at,$productModel->productsModelsTranlations) }}</div>
                                    </div>
                                </div>
                            </div>
